...
export default function Kids_Birthday() {
  return (
    <div>
      <div className="mt-[65px] container mx-auto p-4">
        <div id="Kids-birthday" className="text-center mb-15 headings_border">
        ...
        <div className="container mx-auto sm:mt-10 mt-5 p-4">
